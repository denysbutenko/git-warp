...
`warp release-check --version v0.5.0` verifies that:

- `Cargo.toml` has package version `0.5.0`.
- `CHANGELOG.md` has a `v0.5.0` release heading.
- `docs/releases/v0.5.0.md` exists.
- `docs/install.md` mentions `GIT_WARP_VERSION=v0.5.0`.
