...
```bash
warp release-check --version v0.6.0
```
...
`warp release-check --version v0.6.0` verifies that:

- `Cargo.toml` has package version `0.6.0`.
- `CHANGELOG.md` has a `v0.6.0` release heading.
- `docs/releases/v0.6.0.md` exists.
- `docs/install.md` mentions `GIT_WARP_VERSION=v0.6.0`.
